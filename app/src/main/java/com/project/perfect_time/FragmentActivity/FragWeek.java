package com.project.perfect_time.FragmentActivity;
...
import com.project.perfect_time.DeviceType;
import com.example.perfect_time.R;
import com.project.perfect_time.RecyclerView.RecyclerView_ListAdapter;
import com.project.perfect_time.RecyclerView.RecyclerView_ListItem;
        ...
        for(DB_Week data : week_dataBase_management.getData()){
            ...
            recyclerView_listItem =
                    new RecyclerView_ListItem(0, data.isTimer_Activate(), data.isImportant(), data.getName(), data.getMemo(), data.getTime_Hour(),
                            data.getTime_Minute(), data.getAlarm_Method(), WeekText[data.getDayOfTheWeek()], 0xFF000000, FragmentType.fragWeek);
